...
- Manter compatibilidade com Python >= 3.8 (ver `pyproject.toml`)
- Rodar `pytest` antes de considerar qualquer mudança em `core.py` concluída
...
- Ambiente de dev: `pip install -e ".[dev]"`
- Testes: `pytest -v`
